# Django settings for ExampleDjangoProject project.

DEBUG = True
TEMPLATE_DEBUG = DEBUG

# if DEBUG = True, http port is 8000 and https is 8001
...
SECRET_KEY = '7x=_qm8cp5ci8*s)=(*y(6-nls772d41oxp!agbe(1qu5sueu5'
...
ROOT_URLCONF = 'ExampleDjangoProject.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'ExampleDjangoProject.wsgi.application'
